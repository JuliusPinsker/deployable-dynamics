...
Create a report page that runs all 48 scenarios and summarizes the results in a scientific table with PDF export.
...
* [x] Add a report page test that asserts 48 rows and the export action.
...
* [x] Create `ReportPage.tsx` and generate the 48 scenarios from config, failure mode, and material lists.
...
The report combines 4 configurations, 4 failure modes, and 3 materials for 48 total scenarios.
