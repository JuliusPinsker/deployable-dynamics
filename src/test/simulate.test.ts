...
describe('sample simulation (3U)', () => {
  ...
  it('coupled enforces 3-stage deployment: long-edge stage1, long-edge stage2, then short-edge', () => {
    const delay = 0.8;
    const params = {
      ...DEFAULT_PARAMS,
      hinge: {
    ...
    // Stage 2 must stay locked during stage 1.
    ...
    // Stage 3 must stay locked until stage 2 is complete.
    ...
    // Delayed short-edge panels (indices 5 and 7) should remain stowed for an extra delay.
